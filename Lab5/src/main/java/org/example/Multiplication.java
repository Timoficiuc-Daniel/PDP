...
public class Multiplication {
    ...
    public static Polynomial karatsubaSequentialMultiplication(Polynomial a, Polynomial b) {
        if (a.getDegree() < 100 || b.getDegree() < 100) {
    ...
    public Polynomial karatsubaGood(Polynomial a, Polynomial b) throws InterruptedException, ExecutionException{
        executorService = Executors.newWorkStealingPool(16);
        Polynomial c = karatsubaParallelMultiplication(a,b);
        executorService.shutdown();
        return c;
    }
